...
const usernameVal = usernameEl ? usernameEl.value.trim().toUpperCase() : "";
...
if(usernameVal !== "SVEDENBORG" || value !== "-cšewd',mcc,-"){
...
/* CHAT (legacy - koristi se samo ako ovaj app.js ostane povezan na drugu chat stranicu) */
